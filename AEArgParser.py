...
def createArgParser():
    ...
    coreParser.add_argument('--reducedCapacity', type=bool, default=False, help='Flights over intended range')
    coreParser.add_argument('--autoSlots', type=bool, default=False, help='Automatically buy slots')
    coreParser.add_argument('--autoTerminal', type=bool, default=False, help='Automatically build terminal')
    coreParser.add_argument('--autoHub', type=bool, default=False, help='Automatically create hub')
    ...
    recursiveParser.add_argument('--recursion', type=bool, default=False, help='Airline name')
    ...
    recursiveParser.add_argument('--reducedCapacity', type=bool, default=False, help='Flights over intended range')
    recursiveParser.add_argument('--autoSlots', type=bool, default=False, help='Automatically buy slots')
    recursiveParser.add_argument('--autoTerminal', type=bool, default=False, help='Automatically build terminal')
    recursiveParser.add_argument('--autoHub', type=bool, default=False, help='Automatically create hub')
